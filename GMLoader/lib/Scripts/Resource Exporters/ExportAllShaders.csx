...
foreach (UndertaleShader shader in Data.Shaders)
{
    ...
    if (!shader.HLSL11_VertexData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "HLSL11_VertexData.bin"), shader.HLSL11_VertexData.Data);
    if (!shader.HLSL11_PixelData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "HLSL11_PixelData.bin"), shader.HLSL11_PixelData.Data);
    if (!shader.PSSL_VertexData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "PSSL_VertexData.bin"), shader.PSSL_VertexData.Data);
    if (!shader.PSSL_PixelData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "PSSL_PixelData.bin"), shader.PSSL_PixelData.Data);
    if (!shader.Cg_PSVita_VertexData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "Cg_PSVita_VertexData.bin"), shader.Cg_PSVita_VertexData.Data);
    if (!shader.Cg_PSVita_PixelData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "Cg_PSVita_PixelData.bin"), shader.Cg_PSVita_PixelData.Data);
    if (!shader.Cg_PS3_VertexData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "Cg_PS3_VertexData.bin"), shader.Cg_PS3_VertexData.Data);
    if (!shader.Cg_PS3_PixelData.IsNull)
        File.WriteAllBytes(Paths.JoinVerifyWithinDirectory(exportBase, "Cg_PS3_PixelData.bin"), shader.Cg_PS3_PixelData.Data);
